...
export default {
  ...
  bind(el, { value, arg, modifiers }, node) {
    if (el.__touchswipe !== void 0) {
      destroy(el);
      el.__touchswipe_destroyed = true;
    }
    ...
    modifiers.mouse === true &&
            addEvt(ctx, 'main', [[el, 'mousedown', 'mouseStart', `passive${mouseCapture}`]]);
  ...
  unbind(el) {
    if (el.__touchswipe_destroyed === void 0) {
      destroy(el);
    } else {
      delete el.__touchswipe_destroyed;
    }
  },
};
