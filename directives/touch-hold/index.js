...
export default {
  ...
  bind(el, binding, node) {
    if (el.__touchhold !== void 0) {
      destroy(el);
      el.__touchhold_destroyed = true;
    }
  ...
  unbind(el) {
    if (el.__touchhold_destroyed === void 0) {
      destroy(el);
    } else {
      delete el.__touchhold_destroyed;
    }
  },
};
